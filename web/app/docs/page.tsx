...
const NAV_ITEMS = [
  { href: "#overview",       label: "What you need" },
  { href: "#install",        label: "Install a skill" },
  { href: "#install-order",  label: "Recommended order" },
  { href: "#faq",            label: "FAQ" },
];
      ...
      <div className="max-w-5xl mx-auto px-6 py-14">
        <div className="grid lg:grid-cols-[200px_1fr] gap-12">
          ...
          <div className="flex flex-col gap-16">
            ...
            {/* Overview */}
            <div id="overview" className="bg-primary-light border border-primary/20 rounded-xl p-6">
